...
public class SeguntaVentana extends JFrame {
	...
	private void initialize() {
		...
		nombrePuntaje1.setText(PracticaVentanas.historialDePuntajes.get(0)[0]);
		...
		puntaje1.setText(PracticaVentanas.historialDePuntajes.get(0)[1]);
		puntaje1.setColumns(10);
		puntaje1.setBounds(143, 35, 113, 28);
		getContentPane().add(puntaje1);
		
		nombrePuntaje2 = new JTextField();
		nombrePuntaje2.setText(PracticaVentanas.historialDePuntajes.get(1)[0]);
		...
		puntaje2.setText(PracticaVentanas.historialDePuntajes.get(1)[1]);
		puntaje2.setColumns(10);
		puntaje2.setBounds(143, 74, 113, 28);
		getContentPane().add(puntaje2);
		
		nombrePuntaje3 = new JTextField();
		nombrePuntaje3.setText(PracticaVentanas.historialDePuntajes.get(2)[0]);
		...
		puntaje3.setText(PracticaVentanas.historialDePuntajes.get(2)[1]);
